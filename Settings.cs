...
namespace FalconUDP
{
    static class Settings
    {
        ...
        internal const byte OutOfOrderTolerance         = (byte)Const.HALF_MAX_SEQ_NUMS / 2;      // packets recveived out-of-order from last received greater than this are dropped
    }
}
